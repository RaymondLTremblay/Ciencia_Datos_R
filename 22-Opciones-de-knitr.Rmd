...
***
```{r OK2, include=TRUE, fig.cap= "An incredible figure", echo_opts=TRUE}
library(ggplot2)
...
```{r OK5, include=TRUE, echo=TRUE, fig.cap= "caption", fig.width = 2.6, fig.height = 2.6, fig.align='right'}
df <- data.frame(letters = letters[1:5], value = 1)
