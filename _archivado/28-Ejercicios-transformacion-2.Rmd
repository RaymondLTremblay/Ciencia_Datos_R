...
## 3. ¿Calcular la cantidad cumulativa de número de camas CamasICU {-}

 - Enseñe solamente las últimas 4 filas

```{r c28-6, eval=FALSE, echo=FALSE}
library(MASS)
