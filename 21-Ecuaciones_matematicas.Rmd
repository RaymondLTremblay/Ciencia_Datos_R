...
El promedio $\bar{x}=\frac{\sum x_{i}}{n}$ se escribe como `$\bar{x}=\frac{\sum x_{i}}{n}$`.  Nota que para poner una ecuación en una línea se usa solamemente una `$` antes y depsues, si queremos que sea en una linea aprate se usa dos `$$` antes y despues.
