...
- **`install.packages("x")`:** descarga e instala el paquete desde internet (CRAN). Se hace **una sola vez** por computadora.
- **`library(x)`:** carga el paquete en la sesión actual para poder usar sus funciones. Se hace **en cada sesión**.
