...
- **Cuidado** con el paquete **hms** que tiene funciones igual como **lubridate** (hms, hm, y ms) , pero no necesaramente hace lo mismo.
...
Datos_raros=tribble(~Ind, ~fechas,
                    1, "1/1/30",
                    2, "1/30/01",
                    3, "1/30/09")
