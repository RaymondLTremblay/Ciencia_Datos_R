...
> Este capítulo usa el enfoque de `modelr` (el del libro *R for Data Science*).
> Para un flujo más moderno con `tidymodels`, y para dar formato matemático a los
> ejes con LaTeX, mira los capítulos de *tidyverse avanzado* y de *ecuaciones
> matemáticas*.
